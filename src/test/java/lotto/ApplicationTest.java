...
class ApplicationTest extends NsTest {
    private static final String ERROR_MESSAGE = "[ERROR] 입력된 형식이 올바르지 않습니다(숫자를 입력하세요).";
    private static final String DUPLICATED_NUMBER_ERROR_MESSAGE = "[ERROR] 로또 번호에 중복된 숫자가 있습니다.";
    private static final String OUT_OF_RANGE_ERROR_MESSAGE="[ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다.";
    private static final String INVALID_LENGTH_ERROR_MESSAGE="[ERROR] 정해진 수만큼 숫자를 입력하세요.";
    private static final String INVALID_INPUT_ERROR_MESSAGE="[ERROR] 입력된 형식이 올바르지 않습니다(숫자를 입력하세요).";
    private static final String INVALID_COST_ERROR_MESSAGE="[ERROR] 구입 금액은 0원보다 커야합니다.";
    @Test
    void 기능_테스트() {
    ...
    @DisplayName("로또 당첨 번호에 중복이 있으면 예외 발생.")
